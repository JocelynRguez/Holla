...
public class PlacesAdapter extends RecyclerView.Adapter<PlacesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.tvRating.setText("Rating: " + placeList.get(holder.getAdapterPosition()).getRating());
        holder.tvAddress.setText("Address: " + placeList.get(holder.getAdapterPosition()).getAddress());
        boolean open = placeList.get(holder.getAdapterPosition()).getDescription();
        if (open) {
            holder.tvDetails.setText("Open Now");
        } else {
            holder.tvDetails.setText("Closed Now");
        }
